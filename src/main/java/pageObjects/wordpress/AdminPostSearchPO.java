...
public class AdminPostSearchPO extends BasePage {
	...
	public boolean isPostSearchTableDisplayed(String headerId, String cellValue) {
		int headerIndex = getElementSize(driver, AdminPostSearchPageUI.TABLE_HEADER_INDEX_BY_HEADER_NAME, headerId) + 2;
		waitForElementInVisible(driver, AdminPostSearchPageUI.TABLE_ROW_VALUE_BY_HEADER_INDEX, String.valueOf(headerIndex), cellValue);
